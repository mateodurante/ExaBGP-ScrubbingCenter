...
/usr/sbin/vcmd -c $core_path/n36 -- bash -E -c "/opt/ScrubbingUNLP/start.sh -w http://163.20.252.2/ -b 133.1.0.10 -c /root/exabgpScrubbing1.ini &" &

sleep 5

/usr/sbin/vcmd -c $core_path/ScrubCABASE -- bash -E -c "/opt/ScrubbingUNLP/start.sh -w http://163.20.252.2/ -b 10.0.8.10 -c /root/exabgpScrubbing2.ini &" &
